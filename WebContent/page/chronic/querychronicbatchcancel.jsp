...
<TABLE width="100%" border=0 cellspacing="2" bgcolor="#FCFDFF"
		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="querychronicbatchcancel" method="post"
							theme="simple">
							<table width="99%" border="0" align="center">
								<tr>
									...
									</s:select>&nbsp;&nbsp; 查询值： <s:textfield name="value" size="10"></s:textfield><!--&nbsp;&nbsp;街道审批：
									<s:select value="checked1" name="checked1"
										list="#{'':'全部','1':'同意','0':'不同意'}" listKey="key"
										listValue="value">
									</s:select> &nbsp;&nbsp; 区县审批：<s:select value="checked2" name="checked2"
										list="#{'':'全部','1':'同意','0':'不同意'}" listKey="key"
										listValue="value">
									</s:select> &nbsp;&nbsp;-->&nbsp;&nbsp;<s:submit value="查询"></s:submit>
									&nbsp;&nbsp;
									<button type="button" onclick="c()">已添加审批对象列表</button>
									</td>
								</tr>
							</table>
						</s:form></td>
					...
					<s:iterator value="ccds">
						<tr id="r<s:property value="memberid"/>">
							<td><input type="checkbox"
								id="<s:property value="memberid"/><s:property value="ds"/>" /></td>
			...
			<td>
			<s:property value="icdIdval"/>
			</td>
			<td><s:property value="medicalmoney"/></td>
						</tr>
					</s:iterator>
				</table>
				</td>
	...
	<tr>
		...
		<div align="center"><s:property value="toolsmenu" escape="fasle" />&nbsp;&nbsp;&nbsp;&nbsp;
			<button type="button">批量复审救助对象</button>
		</div>
		</td>
	</tr>
</TABLE>
