		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="querychronicbillbysubject" method="post"
							theme="simple" cssStyle="text-align:left">
							<table width="99%" border="0" align="center">
								<tr>
									<td align="left">发放时间（按时间段）： <input type="text"
										readonly="readonly" id="opertime1" name="opertime1"
										...
										size="10" />&nbsp;&nbsp; 选择科目：<s:select name="type" list="map"
