...
<script type="text/javascript">
	function getdepts(oid) {
		$.ajax({
			type : "post",
			url : "page/chronic/getdept.action",
			data : {
				"oid" : oid
			},
			timeout : 20000,
		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="checkbills" method="post"
					...
					<%-- 				<s:if test="orgid==220506">
										...
										<td><s:select value="biztype" name="biztype"
											list="#{'':'全部','3':'购药','6':'重大疾病门诊购药'}"
											label="业务类型" listKey="key"
				...
				<table width="100%" class="t2" border="0" cellpadding="0"
					...
					<s:iterator value="bizs">
						<tr>
							...
							<td><a
								href="page/basebiz/viewbizpay1.action?bizDTO.bizId=<s:property value="bizId"/>"
							...
							<s:if test="orgid==220506">
								<td><s:property value="dtypename"></s:property></td>
							</s:if>
