		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="querychronicmembermodify" method="post"
							theme="simple">
							<table width="99%" border="0" align="center">
								<tr>
									...
									救助状态：<s:select value="salstatus" name="salstatus" 											
											list="#{'':'全部','1':'救助对象','0':'非救助对象'}"	
												label=" 救助状态：" listKey="key" listValue="value"></s:select>
