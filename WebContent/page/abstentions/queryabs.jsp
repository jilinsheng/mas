				...
				<table align="center" width="100%" class="t2" border="0"
					...
					<s:iterator value="sanwus">
						<tr>
							...
							<td>
							<a href="page/abstentions/editabsinit.action?memberId=<s:property value="memberId"/>&ds=<s:property value="ds"/>&type=edit" target="_blank">修改</a>&nbsp;&nbsp;
