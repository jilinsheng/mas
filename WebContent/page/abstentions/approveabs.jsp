...
<script type="text/javascript">
	...
	function valpaperid(obj) {
		$.ajax({
			...
			data : {
				"paperId" : obj.value,
				"memberId" : $("#editabs_wubaohuDTO_memberId")[0].value
			},
			timeout : 20000,
			error : function() {
				alert("服务器错误");
...
<body>
<p align="center"><s:form action="editabs" method="post"
	...
	<s:hidden name="wubaohuDTO.gongyang" value="4"></s:hidden>
