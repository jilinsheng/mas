		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="querymedicalmembersdone" method="post"
							theme="simple">
							<table width="99%" border="0" align="center">
								<tr>
									<td align="left">选择机构：<s:select
										name="oid" list="orgs" listKey="organizationId"
										listValue="orgname"></s:select>&nbsp;&nbsp;查询条件： <s:select value="term"
										name="term"
									...
									<s:submit value="查询"></s:submit><!-- (<a href="page/basebiz/himap.action" target="_blank" >未审核患者分布图</a>) --></td>
								</tr>
							</table>
						</s:form></td>
					</tr>
