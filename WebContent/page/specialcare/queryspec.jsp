							...
							<table width="99%" border="0" align="center">
								<tr>
									...
									<s:select value="term" name="term"
										list="#{'':'全部','SSN':'优抚证号','FAMILYNO':'家庭编号','MEMBERNAME':'姓名','PAPERID':'身份证号'}"
										...
										人员状态：<s:select value="a5" name="a5"
										list="#{'':'全部','1':'优抚对象','0':'非优抚对象'}"
				...
				<table align="center" width="100%" class="t2" border="0"
					...
					<s:iterator value="specs">
						<tr>
							...
							<td>
							<a href="page/specialcare/editspecinit.action?memberId=<s:property value="memberId"/>&ds=<s:property value="ds"/>&type=edit" target="_blank">修改</a>&nbsp;&nbsp;
