...
<script type="text/javascript">
	...
	function valpaperid(obj) {
		$.ajax({
			...
			data : {
				"paperId" : obj.value,
				"memberId" : $("#editspec_wubaohuDTO_memberId")[0].value
			},
			timeout : 20000,
			error : function() {
				alert("服务器错误");
...
<body>
<p align="center"><s:form action="editspec" method="post"
