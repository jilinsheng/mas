...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="680px" class="formtable">
	...
	<tr>
		...
		<td class="formtd2" ><s:date name="tempDTO.fintime"
			format="yyyy-MM-dd" /></td>
	</tr>
	<tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="680px" class="formtable">	
	...
	<td class="formtd1" width="20%" style="font-weight:bold;color:#104E8B">审批结果：</td>
		<td class="formtd2">
			<s:if test="tempDTO.bizTypeex==2">大病门诊</s:if>
			<s:elseif test="tempDTO.bizTypeex==3">特殊疾病门诊</s:elseif>
			<s:elseif test="tempDTO.bizTypeex==5">特殊疾病住院</s:elseif>
			<s:elseif test="tempDTO.bizTypeex==6">基本医疗住院</s:elseif>
			<s:elseif test="tempDTO.bizTypeex==7">重特大疾病住院</s:elseif></td>
	</tr>
</table>
<table align="center" border="0" cellpadding="0" cellspacing="0" width="680px" class="formtable">
	<tr>
