		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="/page/print/printmaaccounts"
							...
							<table width="99%" border="0" align="center">
								<tr>
									<td align="left">选择机构：<s:select
										name="tempDTO.organizationId" list="orgs"
									...
									救助时间（按时间段）： <input type="text" readonly="readonly"
										...
										value='<s:date name="tempDTO.begintime" format="yyyy-MM-dd"/>' />&nbsp;&nbsp;至&nbsp;&nbsp;
									<input type="text" readonly="readonly" id="endDate"
										name="tempDTO.endtime"
										value='<s:date name="tempDTO.endtime" format="yyyy-MM-dd"/>' />&nbsp;&nbsp;&nbsp;&nbsp;
										数据来源：<s:select   name="tempDTO.memberType"
