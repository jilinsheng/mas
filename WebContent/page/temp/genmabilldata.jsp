...
<script type="text/javascript">
	function viewapply(mid) {
		var url = "genmabillfile.action?tempMonthDTO.mid=" + mid;
		var f = "dialogWidth=400px;dialogHeight=300px;status=no;help=no;scroll=auto";
		window.showModalDialog(url, window, f);
	}
	function viewfile(mid){
		var url = "madownloadExcelInit.action?tempMonthDTO.mid=" + mid;
...
<table align="center" width="650px" class="t2" border="0"
	...
	<tr>
		<td><s:form action="genmabilldata" method="post" theme="simple">
...
<table align="center" width="650px" class="t2" border="0"
	...
	<s:iterator value="months">
		<tr>
			...
			<td><a target="_self" href="page/temp/genmabillfile.action?tempMonthDTO.mid=<s:property value="mid"></s:property>">生成文本文件</a>
			</td>
			<td><a target="_self" href="javascript:void(0);" onclick="viewfile(<s:property value='mid'></s:property>)">生成EXCEL</a></td>
			<td><a target="_self" href="page/temp/removemabillmonth.action?tempMonthDTO.mid=<s:property value="mid"></s:property>">删除</a></td>
		</tr>
	</s:iterator>
</table>
<div align="center">
