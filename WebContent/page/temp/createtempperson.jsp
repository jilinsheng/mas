...
<p align="center"><s:form action="page/temp/createtempperson"
	...
	<table width="600px" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<td width="210px"><s:textfield id="name" name="tempDTO.membername"></s:textfield></td>
		</tr>
		<tr>
			<td>身份证号</td>
		...
		<tr>
			<td>(参保\参合) 编号</td>
			<td><s:textfield id="ssn" name="tempDTO.ssn" cssStyle="width:100%"></s:textfield></td>
			<td>联系方式</td>
