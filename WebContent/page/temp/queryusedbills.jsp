		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="queryusedbills" method="post"
							...
							<table width="99%" border="0" align="center">
								<tr>
									...
									<s:select value="term" name="term"
										list="#{'':'全部','MEMBERNAME':'姓名','PAPERID':'身份证号'}"
									...
									发放月份：<s:select name="app" list="months" listValue="ym" listKey="mid"></s:select> &nbsp;&nbsp; <s:submit
