...
<table width="650px" class="formTitle" align="center">
	<tr>
		<td style="padding-left: 2px"><img
			alt="<s:property
				value="tempDTO.name"></s:property>住院救助信息"
			border="0" src="page/images/aws-dev.gif" /><font
			class="formTitleFont"><s:property value="tempDTO.name"></s:property>住院救助信息</font></td>
	</tr>
</table>
<table align="center" class="formtable" border="0" cellpadding="0"
	...
	<tr>
		...
		<td class="formtd2" width="16%"><s:property value="tempDTO.name"></s:property>&nbsp;</td>
	...
	<tr>
		...
		<td class="formtd2"><s:property value="tempDTO.hospitalname"></s:property>&nbsp;</td>
	</tr>
	<tr>
		<td class="formtd1">确诊患病名称</td>
		<td class="formtd2"><s:property value="tempDTO.diagnoseName"></s:property>&nbsp;</td>
		<td class="formtd1">&nbsp;</td>
		<td class="formtd2">&nbsp;</td>
		<td class="formtd1">&nbsp;</td>
		<td class="formtd2">&nbsp;</td>
...
<%-- 	<s:iterator value="pays"> --%>
		<tr>
			...
			<td class="formtd2"><s:property value="tempDTO.payTotal"></s:property>元</td>
			<td class="formtd1">统筹支付</td>
			<td class="formtd2"><s:property value="tempDTO.payMedicare"></s:property>元</td>
			<td class="formtd1">其他补助</td>
			<td class="formtd2">&nbsp;</td>
		</tr>
		<tr>
			<td class="formtd1">医疗救助</td>
			<td class="formtd2"><s:property value="tempDTO.payAssist"></s:property>元</td>
			<td class="formtd1">个人承担</td>
			<td class="formtd2"><s:property value="tempDTO.payself"></s:property>元</td>
			<td class="formtd1">不予补偿金额</td>
			<td class="formtd2"><s:property value="tempDTO.payOutmedicare"></s:property>元</td>
		</tr>
		<tr>
			<td class="formtd1">大病保险金额</td>
			<td class="formtd2"><s:property value="tempDTO.payCIAssist"/>元</td>
			<td class="formtd1">&nbsp;</td>
			<td class="formtd2">&nbsp;</td>
			<td class="formtd1">&nbsp;</td>
			<td class="formtd2">&nbsp;</td>
...
<%-- 	</s:iterator> --%>
	<s:iterator value="pics">
		<tr>
			<td class="formtd1"><s:property value="filename" /></td>
			<td class="formtd2" colspan="5">
			<div class="jqzoom" style='margin-right: 5px; float: center'>
			<img width="150px" src="<%=b%>yljz/medicalafter/<s:property value="realpath"/>"
				alt="<s:property value="filetypeval" />"
				jqimg="<%=b%>yljz/medicalafter/<s:property value="realpath"/>"></div>
				<a
				href="<%=b%>yljz/medicalafter/<s:property value="realpath"/>" target="_blank">查看大图</a>
			</td>
		</tr>
	</s:iterator>
</table>
