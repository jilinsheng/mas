...
<title>医后报销附件补录查询</title>
<script type="text/javascript">
	function uploadadd(m1){
		var url="afteruploadaddinit.action?tempDTO.approveId="+m1;
		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="queryafterannexadd" method="post"
				...
				<table align="center" width="100%" class="t2" border="0"
					...
					<s:iterator value="tempmembers">
						<tr>
							...
							<td>
							<s:if test="bizStatus==1">同意
							</s:if>
							<s:if test="bizStatus==0">不同意
							</s:if>
