		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="queryaddapprove" method="post"
				...
				<table align="center" width="100%" class="t2" border="0"
					...
					<s:iterator value="tempmembers">
						<tr>
							...
							<td><button type="button" onclick="viewapply('<s:property value="memberId"></s:property>','<s:property value="memberType"></s:property>')">查看业务</button></td>
						</tr>
					</s:iterator>
				</table>
				</td>
