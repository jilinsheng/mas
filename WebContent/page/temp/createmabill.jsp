	...
	function viewapply() {
		...
		window
				.open(
						url,
						'生成临时救助',
						'height=510,width=700,top=50,left=100,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');
	}
</script>
</head>
<body>
<TABLE width="100%" border=0 cellspacing="2" bgcolor="#FCFDFF"
		...
		<TABLE width="100%" border=1 cellspacing="0" bordercolor="#CBDCEE">
			<tr id="searchTable">
				...
				<table width="100%" class="areaBorder">
					<tr>
						<td><s:form action="createmabill" method="post"
	...
	<tr>
		...
		<div align="center"><s:property value="result" />&nbsp;&nbsp;
		<button type="button" onclick="viewapply()">生成发放数据</button>
		</div>
		</td>
	</tr>
</TABLE>
