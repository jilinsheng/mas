...
<div id="facebg">
  <div class="face"> 
  	<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('faceok','','face1ok2.jpg',1)">
		<img src="face1ok1.jpg" name="faceok" width="76" height="27" border="0" id="faceok" />	</a> 
	<a href="face.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('facecancel','','face1cancel2.jpg',1)">
	...
	<table width="210" border="0"  id="loginform">
      <tr> 
	  	<td class="facefont"> �û���</td>
        <td><input name="username"  id="username" class="editbox"/></td>
      </tr>
      <tr> 
	  	<td class="facefont"> ��&nbsp;&nbsp;�룺</td>
        <td><input name="password"  id="password" class="editbox"/></td>
      </tr>
    </table>
  </div>
</div>
