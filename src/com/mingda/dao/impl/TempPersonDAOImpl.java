...
public class TempPersonDAOImpl extends SqlMapClientDaoSupport implements TempPersonDAO {
	...
	public int countByExample(TempPersonExample example) {
		Integer count = (Integer) getSqlMapClientTemplate().queryForObject(
				"TEMP_PERSON.ibatorgenerated_countByExample", example);
		return count;
	}
	...
	public int deleteByExample(TempPersonExample example) {
		int rows = getSqlMapClientTemplate().delete(
				"TEMP_PERSON.ibatorgenerated_deleteByExample", example);
		return rows;
	}
	...
	public int deleteByPrimaryKey(BigDecimal memberId) {
		...
		int rows = getSqlMapClientTemplate().delete(
				"TEMP_PERSON.ibatorgenerated_deleteByPrimaryKey", key);
		return rows;
	}
	...
	public BigDecimal insert(TempPerson record) {
		Object newKey = getSqlMapClientTemplate().insert(
				"TEMP_PERSON.ibatorgenerated_insert", record);
	...
	public BigDecimal insertSelective(TempPerson record) {
		Object newKey = getSqlMapClientTemplate().insert(
				"TEMP_PERSON.ibatorgenerated_insertSelective", record);
		return (BigDecimal) newKey;
	}
	...
	public List<TempPerson> selectByExample(TempPersonExample example) {
		List<TempPerson> list = getSqlMapClientTemplate().queryForList(
				"TEMP_PERSON.ibatorgenerated_selectByExample", example);
		return list;
	}
	...
	public TempPerson selectByPrimaryKey(BigDecimal memberId) {
		TempPerson key = new TempPerson();
		key.setMemberId(memberId);
		TempPerson record = (TempPerson) getSqlMapClientTemplate()
				.queryForObject(
						"TEMP_PERSON.ibatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	 ...
	 * @ibatorgenerated  Sat Feb 16 15:30:53 CST 2013
	 */
	public int updateByExampleSelective(TempPerson record,
			TempPersonExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"TEMP_PERSON.ibatorgenerated_updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateByExample(TempPerson record, TempPersonExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"TEMP_PERSON.ibatorgenerated_updateByExample", parms);
		return rows;
	}
	...
	public int updateByPrimaryKeySelective(TempPerson record) {
		int rows = getSqlMapClientTemplate().update(
				"TEMP_PERSON.ibatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public int updateByPrimaryKey(TempPerson record) {
		int rows = getSqlMapClientTemplate().update(
				"TEMP_PERSON.ibatorgenerated_updateByPrimaryKey", record);
		return rows;
	}
