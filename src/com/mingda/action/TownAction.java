...
public class TownAction extends ActionSupport {
	static final Logger log = Logger.getLogger(TownAction.class);
	private String oid;
	private String term;
	...
	public String edittypeinit(){
		if(memberId == null || "".equals(memberId)){
			...
			memberBaseinfoviewDTO = searchService.edittypeinit(memberId,"2");
	...
	public String edittype(){
		...
		String err[] = { "" };
		int i = searchService.editType(memberId, "2", wubaohuFlag, youfuFlag, assistType, sanwuFlag, guerFlag, assistTypex, medicaretype);
		if (i == 1) {
			err[0] = "1";
		}else{
			err[0] = "0";
